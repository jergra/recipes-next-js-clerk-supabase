  ...
  return (
    <div className='flex flex-col w-full h-full items-center justify-between bg-slate-900'>
      ...
      <main className='flex flex-col w-full items-center'>
        ...
        <div className='mt-8 w-11/12 h-[380px] flex flex-wrap flex-col items-center bg-slate-900'>
          <div className='w-11/12 p-3 rounded-lg h-[380px] flex flex-col flex-wrap items-center'>
            {recipeData.map((recipe, index) => (
              <div
                className='cursor-pointer text-xl w-[297px] bg-slate-50 pl-3'
                key={index}
